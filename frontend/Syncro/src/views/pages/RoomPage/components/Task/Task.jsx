...
import { Icon_arrow_circle, Icon_check, Icon_cross, Icon_edit, Icon_trash } from '../../../../../assets/icons';
...
export default function Task({ taskInfo }) {
    ...
    const triggerPanel = () => {
        setPanel({
            ...
            actions: [
                {key:'toggleDone', className:'confirmButton', name:(taskInfo.done ? 'Not done': 'Done'),   icon: taskInfo.done ? <Icon_arrow_circle /> : <Icon_check />, function:toggleDone},
                {key:'editTask', className:'warningButton', name:"Edit", icon:<Icon_edit/>, function:editTask},
                {key:'deleteTask', className:'cancelButton', name: "Delete", icon:<Icon_trash/>, function:removeTask}
            ],
        });
    }
